...
class Buffer protected () extends Uint8Array( /* dummy to trick constructor */ -1) with BufferMaker {
  ...
  /** Compares `buf` with `target` and returns a number indicating whether `buf` comes before, after, or is the same as
    ...
    * @param targetEnd
    *   The offset with target at which to end comparison (not inclusive). Ignored when targetStart is undefined.
  ...
  /** Copies data from a region of `buf` to a region in `target` even if the `target` memory region overlaps with `buf`.
    ...
    * @param sourceEnd
    *   The offset within buf at which to stop copying (not inclusive). Ignored when sourceStart is undefined. Default:
    *   buf.length
    * @return
  ...
  /** Returns the amount of memory allocated for buf in bytes. Note that this does not necessarily reflect the amount of
    * "usable" data within buf.
    * @return
  ...
  /** Reads a 64-bit double from buf at the specified offset with specified endian format (readDoubleBE() returns big
    * endian, readDoubleLE() returns little endian).
    *
    * Setting noAssert to true allows offset to be beyond the end of buf, but the result should be considered undefined
    * behavior.
    * @param offset
  ...
  /** Reads a 32-bit float from buf at the specified offset with specified endian format (readFloatBE() returns big
    * endian, readFloatLE() returns little endian).
    *
    * Setting noAssert to true allows offset to be beyond the end of buf, but the result should be considered undefined
    * behavior.
    * @param offset
  ...
  /** Reads a signed 16-bit integer from buf at the specified offset with the specified endian format (readInt16BE()
  ...
  /** Reads a signed 32-bit integer from buf at the specified offset with the specified endian format (readInt32BE()
    * returns big endian, readInt32LE() returns little endian).
    *
    * Setting noAssert to true allows offset to be beyond the end of buf, but the result should be considered undefined
    * behavior.
    *
  ...
  /** Reads byteLength number of bytes from buf at the specified offset and interprets the result as a two's complement
    * signed value. Supports up to 48 bits of accuracy.
    *
    * Setting noAssert to true allows offset to be beyond the end of buf, but the result should be considered undefined
    * behavior.
    * @param offset
  ...
  /** Reads an unsigned 8-bit integer from buf at the specified offset. Setting noAssert to true allows offset to be
    * beyond the end of buf, but the result should be considered undefined behavior.
    * @param offset
    *   Where to start reading. Must satisfy: 0 <= offset <= buf.length - 1
    * @param noAssert
    *   Skip offset validation? Default: false
  ...
  /** Reads an unsigned 16-bit integer from buf at the specified offset with specified endian format (readUInt16BE()
    * returns big endian, readUInt16LE() returns little endian).
    *
    * Setting noAssert to true allows offset to be beyond the end of buf, but the result should be considered undefined
    * behavior.
    * @param offset
  ...
  /** Reads an unsigned 32-bit integer from buf at the specified offset with specified endian format (readUInt32BE()
    * returns big endian, readUInt32LE() returns little endian). * Setting noAssert to true allows offset to be beyond
  ...
  /** Returns a new Buffer that references the same memory as the original, but offset and cropped by the start and end
    * indices.
    *
    * Note that modifying the new Buffer slice will modify the memory in the original Buffer because the allocated
    * memory of the two objects overlap.
    * @param start
  ...
  /** Interprets buf as an array of unsigned 16-bit integers and swaps the byte-order in-place. Throws a RangeError if
    * buf.length is not a multiple of 2.
    * @return
    *   A reference to buf
    * @example
    *   buf.swap16()
  ...
  /** Interprets buf as an array of unsigned 32-bit integers and swaps the byte-order in-place. Throws a RangeError if
    * buf.length is not a multiple of 4.
    * @return
    *   A reference to buf
    * @example
    *   buf.swap32()
  ...
  /** Interprets buf as an array of unsigned 64-bit numbers and swaps the byte-order in-place. Throws a RangeError if
    * buf.length is not a multiple of 8.
    * @return
    *   A reference to buf
    * @example
    *   buf.swap64()
  ...
  /** Returns a JSON representation of buf. JSON.stringify() implicitly calls this function when stringifying a Buffer
    * instance.
    * @return
  ...
  /** Decodes buf to a string according to the specified character encoding in encoding. start and end may be passed to
    * decode only a subset of buf.
    * @param encoding
  ...
  /** Re-encodes the given Buffer instance from one character encoding to another. Returns a new Buffer instance. Throws
    * if the fromEnc or toEnc specify invalid character encodings or if conversion from fromEnc to toEnc is not
    * permitted.
    * @param source
    *   A Buffer instance
    * @param fromEnc
  ...
  /** Creates and returns an iterator for buf values (bytes). This function is called automatically when a [[Buffer]] is
    * used in a for..of statement.
    * @return
  ...
  /** Writes string to buf at offset according to the character encoding in encoding. The length parameter is the number
    * of bytes to write. If buf did not contain enough space to fit the entire string, only a partial amount of string
  ...
  /** Writes value to buf at the specified offset with specified endian format (writeDoubleBE() writes big endian,
    * writeDoubleLE() writes little endian). value should be a valid 64-bit double. Behavior is undefined when value is
    * anything other than a 64-bit double.
    *
  ...
  /** Writes value to buf at the specified offset with specified endian format (writeFloatBE() writes big endian,
    * writeFloatLE() writes little endian). value should be a valid 32-bit float. Behavior is undefined when value is
    * anything other than a 32-bit float.
    *
    * Setting noAssert to true allows the encoded form of value to extend beyond the end of buf, but the result should
    * be considered undefined behavior.
    * @param value
  ...
  /** Writes value to buf at the specified offset. value should be a valid signed 8-bit integer. Behavior is undefined
    * when value is anything other than a signed 8-bit integer.
    *
    * Setting noAssert to true allows the encoded form of value to extend beyond the end of buf, but the result should
    * be considered undefined behavior.
    *
  ...
  /** Writes value to buf at the specified offset with specified endian format (writeInt16BE() writes big endian,
    * writeInt16LE() writes little endian). value should be a valid signed 16-bit integer. Behavior is undefined when
  ...
  /** Writes value to buf at the specified offset with specified endian format (writeInt32BE() writes big endian,
    * writeInt32LE() writes little endian). value should be a valid signed 32-bit integer. Behavior is undefined when
  ...
  /** Writes byteLength bytes of value to buf at the specified offset. Supports up to 48 bits of accuracy. Behavior is
    * undefined when value is anything other than a signed integer.
    *
    * Setting noAssert to true allows the encoded form of value to extend beyond the end of buf, but the result should
    * be considered undefined behavior.
    * @param value
  ...
  /** Writes value to buf at the specified offset. value should be a valid unsigned 8-bit integer. Behavior is undefined
    * when value is anything other than an unsigned 8-bit integer.
    *
    * Setting noAssert to true allows the encoded form of value to extend beyond the end of buf, but the result should
    * be considered undefined behavior.
    * @param value
  ...
  /** Writes value to buf at the specified offset with specified endian format (writeUInt16BE() writes big endian,
    * writeUInt16LE() writes little endian). value should be a valid unsigned 16-bit integer. Behavior is undefined when
  ...
  /** Writes value to buf at the specified offset with specified endian format (writeUInt32BE() writes big endian,
    * writeUInt32LE() writes little endian). value should be a valid unsigned 32-bit integer. Behavior is undefined when
  ...
  /** Writes byteLength bytes of value to buf at the specified offset. Supports up to 48 bits of accuracy. Behavior is
    * undefined when value is anything other than an unsigned integer.
    *
    * Setting noAssert to true allows the encoded form of value to extend beyond the end of buf, but the result should
    * be considered undefined behavior.
    * @param value
...
object Buffer extends js.Object {
  ...
  /** Allocates a new `Buffer` of `size` bytes. If `size` is larger than [[constants.MAX_LENGTH]] or smaller than `0`,
  ...
  /** Compares `buf1` to `buf2` typically for the purpose of sorting arrays of `Buffer` instances. This is equivalent to
    * calling `buf1.compare(buf2)`.
    *
    * @see
  ...
  /** Creates a new `Buffer` containing `string`. The `encoding` parameter identifies the character encoding of
    * `string`.
    * @param str
    *   A string to encode.
    * @param encoding
